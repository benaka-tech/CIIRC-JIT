...
class Ui_MainWindow1(object):
    def setupUi(self, MainWindow):
        ...
        self.pushButton_7.setGeometry(QtCore.QRect(164, 340, 131, 23))
        ...
        self.pushButton_3.setGeometry(QtCore.QRect(80, 520, 91, 51))
        self.pushButton_3.setObjectName("pushButton_3")
        self.pushButton_4 = QtWidgets.QPushButton(self.groupBox)
        self.pushButton_4.setGeometry(QtCore.QRect(230, 520, 101, 51))
        self.pushButton_4.setObjectName("pushButton_4")
        self.label_14 = QtWidgets.QLabel(self.centralwidget)
        self.label_14.setGeometry(QtCore.QRect(30, 770, 761, 41))
        font = QtGui.QFont()
        font.setPointSize(10)
    ...
    def caputure(self):
        while (self.cap.isOpened()):
            ...
            f = open("/final_copy/photos\\photos.txt", "a")
            f.write('\n')
            f.write('file:///C:\\Users\\Benaka\\PycharmProjects\\pythonProject\\img\\photos\\photo-%s.png' % (
    ...
    def caputure1(self):
        while (self.cap1.isOpened()):
            ...
            cv2.imwrite('C:\\Users\\Benaka\\PycharmProjects\\pythonProject\\img\\ids\\id-%s.png' % (
                str(datetime.now().strftime("%Y%m%d%H%M%S"))), frame)
            f = open("/final_copy/ids\\ids.txt", "a")
            f.write('\n')
    ...
    def sumbit(self):
        ...
        with open("/final_copy/photos\\photos.txt", "r") as file:
            for last_line in file:
                pass
        filename = str(last_line)
        with open("/final_copy/ids\\ids.txt", "r") as file:
            for last_line1 in file:
                pass
        filename2 = str(last_line1)

        with open("C:\\Users\\Benaka\\PycharmProjects\\pythonProject\\final_copy\\temp.txt", "r") as file:
